...
class MochatChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        try:
            ...
            logger.error("Failed to send Mochat message: %s", e)
    ...
    async def _start_socket_client(self) -> bool:
        ...
        try:
            ...
            logger.error("Failed to connect Mochat websocket: %s", e)
            try:
    ...
    async def _refresh_loop(self) -> None:
        ...
        while self._running:
            ...
            try:
                ...
                logger.warning("Mochat refresh failed: %s", e)
    ...
    async def _refresh_sessions_directory(self, subscribe_new: bool) -> None:
        try:
            ...
            logger.warning("Mochat listSessions failed: %s", e)
            return
    ...
    async def _refresh_panels(self, subscribe_new: bool) -> None:
        try:
            ...
            logger.warning("Mochat getWorkspaceGroup failed: %s", e)
            return
    ...
    async def _session_watch_worker(self, session_id: str) -> None:
        while self._running and self._fallback_mode:
            try:
                ...
                logger.warning("Mochat watch fallback error (%s): %s", session_id, e)
    ...
    async def _panel_poll_worker(self, panel_id: str) -> None:
        ...
        while self._running and self._fallback_mode:
            try:
                ...
                logger.warning("Mochat panel polling error (%s): %s", panel_id, e)
    ...
    async def _load_session_cursors(self) -> None:
        ...
        try:
            ...
            logger.warning("Failed to read Mochat cursor file: %s", e)
            return
    ...
    async def _save_session_cursors(self) -> None:
        try:
            ...
            logger.warning("Failed to save Mochat cursor file: %s", e)
